  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-5xl mx-auto">
        ...
        >
          <span className="w-1.5 h-1.5 rounded-full" style={{ background: "#05e3c2", boxShadow: "0 0 6px #05e3c2" }} />
          {t("hero.badge")}
        </div>

        {/* Headlines */}
        <h1 className="font-black leading-none tracking-tight mb-6" style={{ fontSize: "clamp(52px, 8vw, 110px)" }}>
          <span className="hero-line-1 block text-white">{t("hero.line1")}</span>
          <span className="hero-line-2 block text-white">{t("hero.line2")}</span>
          <span className="hero-line-3 block text-gradient">{t("hero.line3")}</span>
        </h1>
      ...
      {/* Scroll arrow */}
      <div className="bounce absolute text-2xl" style={{ bottom: 32, left: "50%", color: "rgba(5,227,194,0.5)" }}>
        ↓
      </div>
