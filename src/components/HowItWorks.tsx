...
const STEPS = [
  ...
  },
  {
    ...
    desc: "Get smart, proactive alerts at exactly the right moment. Suku thinks ahead so you don't have to.",
  },
];
  ...
  return (
    <section className="py-28 px-6 max-w-7xl mx-auto">
      <div ref={titleRef} className="reveal text-center mb-20">
        <p className="text-sm font-semibold tracking-widest uppercase mb-4" style={{ color: "#05e3c2" }}>How it works</p>
